...
class JackpotGamesAdapter(private val gameListener: GameListener) :
    RecyclerView.Adapter<JackpotGamesAdapter.GameViewHolder>(), TranslationListener {
    ...
    override fun onTranslationReceived(dictionary: Map<String?, String?>) {
        game = dictionary[Translation.Jackpot.GAME] ?: context.resources.getString(R.string.jackpot_game)
        alternativeGame = dictionary[Translation.Jackpot.ALTERNATIVE_GAME] ?: context.resources.getString(R.string.jackpot_alternative_game)
    }
}